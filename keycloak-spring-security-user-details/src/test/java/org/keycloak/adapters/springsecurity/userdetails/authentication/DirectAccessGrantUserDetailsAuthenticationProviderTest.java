...
public class DirectAccessGrantUserDetailsAuthenticationProviderTest {

    @Autowired
    private DirectAccessGrantUserDetailsAuthenticationProvider provider;

    private DirectAccessGrantToken token;
